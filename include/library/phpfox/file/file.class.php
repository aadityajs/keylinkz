 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: file.class.php 3354 2011-10-25 11:46:52Z Miguel_Espinoza $
 */
class Phpfox_File
{
	/**
    ...
    public function upload($sFormItem, $sDestination, $sFileName, $bModifyFileName = true, $iPerm = 0644, $buildDir = true, $bCdn = true)
    {
		...
		{
			Phpfox::getLib('cdn')->put($sDestination . str_replace('\\', '/', str_replace($sDestination, '', $this->_sDestination) . $sFileName . '.' . $this->_sExt));
		}		
	...
	{	    
		...
		{
			$sFile = Phpfox::getLib('cdn')->getUrl(str_replace(PHPFOX_DIR, Phpfox::getParam('core.path'), $sFile));		
		}		
