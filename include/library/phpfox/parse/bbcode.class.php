 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: bbcode.class.php 3584 2011-11-28 06:53:27Z Raymond_Benc $
 */
	...
	{		
		...
		if (isset($this->_aAttachments[$iId]))
		{
			...
			elseif ($this->_aAttachments[$iId]['is_video'])
			{
				...
				$sStr = '<span id="js_attachment_id_' . $iId . '"><a href="#" class="play_link" onclick="$.ajaxCall(\'attachment.playVideo\', \'attachment_id=' . $iId . '\', \'GET\'); return false;">';
