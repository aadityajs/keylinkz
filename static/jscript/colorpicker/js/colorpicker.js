...
(function ($) {
	var ColorPicker = function () {
		var
			...
			{
				var cal = $(this).parent();
				cal.data('colorpicker').onSubmit('transparent', 'transparent', 'transparent');
			},
			show = function (ev) {
			...
			init: function (options) {
				...
				return this.each(function () {
					if (!$(this).data('colorpickerId')) {
						...
						cal.find('div.colorpicker_transparent').bind('click', clickTransparent);
