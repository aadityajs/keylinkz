...
<div class="item_tag_holder">
	...
	<span id="js_quick_edit_tag{$iItemId}">{foreach from=$aTags item=aTag name=tag}{if $phpfox.iteration.tag != 1}, {/if}<a href="{$aTag.tag_url}">{$aTag.tag_text|clean|shorten:55:'...'|split:20}</a>{/foreach}</span>
