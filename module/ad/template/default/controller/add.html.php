 ...
 * @author  		Raymond_Benc
 * @package 		Phpfox
 * @version 		$Id: add.html.php 3713 2011-12-07 12:40:59Z Miguel_Espinoza $
 */
...
<div id="js_upload_image_holder_frame">	
	<div id="js_upload_image_holder" style="z-index:999;" class="ajax_link_reset">
		<form method="post" action="{url link='ad.image'}" target="upload_ad_iframe" enctype="multipart/form-data">			
			...
			<a href="#" onclick="$('#js_upload_image_holder_frame').hide(); return false;">Close</a>
		</form>
	</div>
		...
		<div>
			<div id="js_sample_ad_form_728_90" class="js_ad_holder" style="display:none; width:728px; height:90px; background:#fff; border:1px #bcccd1 solid; text-align:left; overflow:hidden;">
				<div style="padding:5px;">
					<div class="js_ad_image" style="padding-top:6px; float:left; width:125px; text-align:center; font-size:12pt; font-weight:bold;"><span class="js_image_place_holder"></span>{phrase var='ad.image_placement'}</div>
	...
	<div id="step_1">
		...
		<div class="table">
			...
			<div class="table_right">
				...
				<span id="js_ad_position_selected" style="display:none;"><span></span> (<a href="#?call=ad.sample&amp;no-click&amp;width=scan" class="inlinePopup" title="{phrase var='admincp.sample_layout'}">{phrase var='ad.change'}</a>)</span>
				<span id="js_ad_position_select"><a href="#?call=ad.sample&amp;no-click&amp;width=scan" class="inlinePopup" title="{phrase var='admincp.sample_layout'}">{phrase var='ad.select_a_position'}</a></span>
			</div>
			<div class="clear"></div>
		</div>
	...
	<div id="js_ad_continue_next_step" style="display:none;">
		...
		<div class="table">
			...
			<div class="table_right">
				...
				<span id="js_ad_cost_recalculate" style="display:none;"><a href="#" onclick="$.ajaxCall('ad.recalculate', 'total=' + $('#total_view').val() + '&location=' + $('#location').val()); return false;">{phrase var='ad.recalculate_costs'}</a></span>
