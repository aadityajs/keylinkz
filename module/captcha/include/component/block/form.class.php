 ...
 * @version 		$Id: form.class.php 3691 2011-12-06 12:55:54Z Raymond_Benc $
 */
class Captcha_Component_Block_Form extends Phpfox_Component 
{
	...
	public function process()
	{
		...
		$this->template()->assign(array(
				...
				'sCaptchaData' => (Phpfox::getParam('captcha.recaptcha') ? recaptcha_get_html(Phpfox::getParam('captcha.recaptcha_public_key'), null, $bHttps) : null),
