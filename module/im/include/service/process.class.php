...
class Im_Service_Process extends Phpfox_Service 
{
	...
	public function addText($aVals)
	{
		...
		if (isset($aVals['text']) && Phpfox::getLib('parse.format')->isEmpty($aVals['text']))
		{
			return false;
		}		
		
		$aVals = $this->validator()->process($aValid, $aVals);
		...
		$aVals['text'] = $this->preParse()->clean($aVals['text'], 255);
