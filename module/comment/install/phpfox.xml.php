<module>
	...
	<settings>
		...
		<setting group="" module_id="comment" is_hidden="0" type="integer" var_name="total_amount_of_comments_to_load" phrase_var_name="setting_total_amount_of_comments_to_load" ordering="1" version_id="3.0.0Beta1">10</setting>
		...
		<setting group="" module_id="comment" is_hidden="0" type="integer" var_name="total_child_comments" phrase_var_name="setting_total_child_comments" ordering="1" version_id="2.0.0rc1">4</setting>
...
Note: This is only used if threaded replies are enabled.</info>]]></phrase>
	...
	<user_group_settings>
		<setting is_admin_setting="0" module_id="comment" type="boolean" admin="1" user="1" guest="0" staff="1" module="comment" ordering="0">wysiwyg_on_comments</setting>
