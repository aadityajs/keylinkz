 ...
 * @version 		$Id: ajax.class.php 3774 2011-12-13 12:58:37Z Raymond_Benc $
 */
class Comment_Component_Ajax_Ajax extends Phpfox_Ajax
{
	...
	{		
		...
		if (!isset($aVals['is_via_feed']) && Phpfox::isModule('captcha') && !isset($bNoCaptcha) && Phpfox::getUserParam('captcha.captcha_on_comment') && !Phpfox::getService('captcha')->checkHash($aVals['image_verification']))
		{
			$bPassCaptcha = false;
