 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: rsvp.html.php 1948 2010-10-27 12:53:47Z Miguel_Espinoza $
 */
...
{/if}
	...
	<div id="js_event_rsvp_button" class="p_2" style="margin-top:10px;{if $aEvent.rsvp_id} display:none;{/if}">
		<input type="submit" value="{if $aEvent.rsvp_id}{phrase var='event.update_your_rsvp'}{else}{phrase var='event.submit_your_rsvp'}{/if}" class="button" /> <span id="js_event_rsvp_update"></span>
	</div>
</form>