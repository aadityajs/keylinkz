				...
				{/if}
					<div class="row_title">	
						...
						<div class="row_title_info">		
							...
							<div class="extra_info">
								<ul class="extra_info_middot"><li>{$aEvent.start_time_phrase} {phrase var='event.at'} {$aEvent.start_time_phrase_stamp}</li><li><span>&middot;</span></li><li>{$aEvent|user}</li></ul>
							</div>
