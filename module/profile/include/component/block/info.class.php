 ...
 * @version 		$Id: info.class.php 3202 2011-09-27 13:28:45Z Miguel_Espinoza $
 */
class Profile_Component_Block_Info extends Phpfox_Component
{
	...
	{		
		...
		*/
		...
		{
			$sExtraLocation .= '<div class="p_2"><a href="' . $this->url()->makeUrl('user.browse', array('location' => $aUser['country_iso'], 'state' => $aUser['country_child_id'], 'city-name' => urlencode($aUser['city_location']))) . '">' . Phpfox::getLib('parse.output')->clean($aUser['city_location']) . '</a> &raquo;</div>';
		}		
