 ...
 * @version 		$Id: index.class.php 3891 2012-01-24 18:17:09Z Raymond_Benc $
 */
class Profile_Component_Controller_Index extends Phpfox_Component
{
	...
	public function process()
	{
		...
		Phpfox::getService('profile')->setUserId($display_user_id);
		
		//echo Phpfox::getService('profile')->getProfileUserId();
		...
		if ((!isset($aRow['user_id'])) || (isset($aRow['user_id']) && $aRow['profile_page_id']  > 0))
		{
			...
			if (Phpfox::getService('pages')->isPage($this->request()->get('req1')))
			{
