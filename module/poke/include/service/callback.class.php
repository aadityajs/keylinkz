	...
	public function addLike($iItemId, $bDoNotSendEmail = false)
	{
		...
		if (!$bDoNotSendEmail)
		{
			...
			Phpfox::getLib('mail')->to($aRow['user_id'])
				->subject(Phpfox::getPhrase('poke.full_name_liked_one_of_your_pokes', array('full_name' => Phpfox::getUserBy('full_name'))))
				->message(Phpfox::getPhrase('poke.full_name_liked_when_you_poked_row_full_name', array('full_name' => Phpfox::getUserBy('full_name'), 'link' => $sLink, 'row_full_name' => $aRow['full_name'])))
