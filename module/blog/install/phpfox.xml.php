<module>
	...
	<settings>
		...
		<setting group="" module_id="blog" is_hidden="0" type="boolean" var_name="blog_display_user_post_count" phrase_var_name="setting_blog_display_user_post_count" ordering="1" version_id="2.0.0alpha1">1</setting>
		...
		<setting group="" module_id="blog" is_hidden="0" type="boolean" var_name="digg_integration" phrase_var_name="setting_digg_integration" ordering="1" version_id="2.0.0rc8">1</setting>
		<setting group="" module_id="blog" is_hidden="0" type="integer" var_name="blog_cache_minutes" phrase_var_name="setting_blog_cache_minutes" ordering="1" version_id="3.0.0Beta1">0</setting>
		<setting group="" module_id="blog" is_hidden="0" type="integer" var_name="total_pages_to_cache_blog" phrase_var_name="setting_total_pages_to_cache_blog" ordering="1" version_id="3.0.0Beta1">4</setting>
	</settings>
	<blocks>
