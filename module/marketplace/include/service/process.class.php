 ...
 * @version 		$Id: process.class.php 3551 2011-11-22 14:49:19Z Raymond_Benc $
 */
class Marketplace_Service_Process extends Phpfox_Service 
{
	...
	public function approve($iId)
	{
		...
		(Phpfox::isModule('feed') ? Phpfox::getService('feed.process')->add('marketplace', $iId, $aListing['privacy'], (isset($aListing['privacy_comment']) ? (int) $aListing['privacy_comment'] : 0), 0, $aListing['user_id']) : null);				
