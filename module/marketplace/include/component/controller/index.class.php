 ...
 * @version 		$Id: index.class.php 3842 2012-01-04 14:00:10Z Miguel_Espinoza $
 */
	...
	public function process()
	{
		...
		$aSearchFields = array(				
				...
				'search_tool' => array(
					...
					'sort' => array(
						'latest' => array('l.time_stamp', Phpfox::getPhrase('marketplace.latest')),
						//'most-viewed' => array('l.total_view', Phpfox::getPhrase('marketplace.most_viewed')),
						'most-liked' => array('l.total_like', Phpfox::getPhrase('marketplace.most_liked')),
						'most-talked' => array('l.total_comment', Phpfox::getPhrase('marketplace.most_discussed'))
					),
		...
		if ($this->request()->get('sponsor') == 'help')
		{
		    $oFilter->setCondition('AND m.user_id = ' . Phpfox::getUserId() . ' AND is_sponsor != 1');
		}
