...
<div style="height:300px;" class="label_flow js_sortable_empty">
	...
	<div class="js_module_block_parent">
		<div class="module dnd_move_module" onclick="if (!$(this).hasClass('dnd_move_module_active')) {l} p('test'); $(this).addClass('dnd_move_module_active'); $(this).parent().find('.dnd_move_component:first').slideDown('fast'); {r} else {l} $(this).removeClass('dnd_move_module_active'); $(this).parent().find('.dnd_move_component:first').slideUp('fast'); {r}">
			{$sModule}
		</div>
