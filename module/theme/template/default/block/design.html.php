 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: design.html.php 3784 2011-12-13 17:43:19Z Raymond_Benc $
 */
...
<div id="js_style_holder">
	...
	<div class="js_designer_section" id="js_designer_advanced" style="display:none;">										
		...
		<form method="post" action="#" onsubmit="$('#js_save_css_button').attr('disabled', true).addClass('disabled'); $('#js_save_css').show(); $(this).ajaxCall('theme.updateCss'); return false;">
			<div><input type="hidden" name="type_id" value="{$aDesigner.type_id}" /></div>
			<div class="style_submit_box">
