 ...
 * @version 		$Id: style.class.php 3692 2011-12-06 14:56:04Z Miguel_Espinoza $
 */
class Theme_Service_Style_Style extends Phpfox_Service 
{
	...
	{	
		...
		return array(str_replace(PHPFOX_DIR, Phpfox::getParam('core.path'), $iActualImage), false, $iWidth, $iHeight);
	}
