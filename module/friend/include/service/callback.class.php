 ...
 * @version 		$Id: callback.class.php 3894 2012-01-25 12:50:26Z Raymond_Benc $
 */
	...
	*/
	public function getNotificationAccepted($aNotification)
	{
		return array(
			...
			'message' => Phpfox::getPhrase('friend.full_name_added_you_as_a_friend', array('full_name' => $aNotification['full_name'])),
