...
class Friend_Component_Controller_Profile extends Phpfox_Component
{
	...
	public function process()
	{
		...
		$this->template()->setTitle(Phpfox::getPhrase('friend.full_name_s_friends', array('full_name' => $aUser['full_name'])))
			...
			//echo '<pre>'.print_r($aFriends,true).'</pre>';
			//exit;

		//$this->template()->setHeader('jRating.jquery.css', 'module_friend');
		//$this->template()->setHeader('jquery.js', 'module_friend');
		//$this->template()->setHeader('jRating.jquery.js', 'module_friend');
		//$this->template()->setHeader('sample.js', 'module_friend');
	}
