 ...
 * @version 		$Id: moderation.class.php 2696 2011-06-30 19:30:33Z Raymond_Benc $
 */
	...
	{		
		...
		foreach ((array) $_COOKIE as $sCookieName => $sCookieValue)
		{
			if (preg_match('/js_item_m_/i', $sCookieName) && strpos($sCookieValue, '_'))
			{
				...
				{
					$sInputFields .= '<div class="js_item_m_' . $aParts[0] . '_' . $aParts[1] . '"><input type="hidden" name="item_moderate[]" value="' . $aParts[1] . '" /></div>';
					$iTotalInputFields++;
				}
			}
		}
