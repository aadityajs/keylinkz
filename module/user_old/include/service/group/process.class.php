 ...
 * @version 		$Id: process.class.php 3899 2012-01-26 12:24:32Z Raymond_Benc $
 */
	...
	{		
		...
		{	
			$this->database()->insert(Phpfox::getT('user_group_custom'), array(
					...
					'default_value' => (isset($aCacheSettings[$aGroupSetting['setting_id']]) ? $aCacheSettings[$aGroupSetting['setting_id']] : $aGroupSetting[(empty($sVar) ? 'default_value' : $sVar)])
				)
			);
		}		
