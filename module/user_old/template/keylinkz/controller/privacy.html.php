 ...
 * @author  		Raymond Benc
 * @package  		Module_User
 * @version 		$Id: privacy.html.php 3346 2011-10-24 15:20:05Z Raymond_Benc $
 */
			...
			<div class="table">
				...
				<div class="table_right">
					<select name="val[special][dob_setting]">
						<option value="0"{if empty($aUserInfo.dob_setting)} selected="selected"{/if}>{phrase var='user.show_my_full_birthday_in_my_profile'}</option>					
