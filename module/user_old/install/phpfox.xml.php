<module>
	<data>
		...
		<writable><![CDATA[a:1:{i:0;s:14:"file/pic/user/";}]]></writable>
	</data>
	<menus>
	...
	<settings>
		...
		<setting group="" module_id="user" is_hidden="0" type="drop" var_name="login_module" phrase_var_name="setting_login_module" ordering="0" version_id="2.0.0alpha1"><![CDATA[a:2:{s:7:"default";s:6:"cookie";s:6:"values";a:2:{i:0;s:6:"cookie";i:1;s:7:"session";}}]]></setting>
...
->execute('getSlaveField');]]></stat>
	...
	<custom_field>
		...
		<field group_name="user.custom_group_about_me" field_name="who_i_d_like_to_meet" module_id="user" type_id="user_main" phrase_var_name="user.custom_who_i_d_like_to_meet" type_name="MEDIUMTEXT" var_type="textarea" is_active="1" is_required="0" ordering="2" />
		<field group_name="user.custom_group_interests" field_name="interests" module_id="user" type_id="user_main" phrase_var_name="user.custom_interests" type_name="MEDIUMTEXT" var_type="textarea" is_active="1" is_required="0" ordering="4" />
		<field group_name="user.custom_group_interests" field_name="music" module_id="user" type_id="user_main" phrase_var_name="user.custom_music" type_name="MEDIUMTEXT" var_type="textarea" is_active="1" is_required="0" ordering="5" />
		<field group_name="user.custom_group_interests" field_name="movies" module_id="user" type_id="user_main" phrase_var_name="user.custom_movies" type_name="MEDIUMTEXT" var_type="textarea" is_active="1" is_required="0" ordering="3" />
		<field group_name="user.custom_group_details" field_name="smoker" module_id="user" type_id="user_panel" phrase_var_name="user.custom_smoker" type_name="VARCHAR(150)" var_type="select" is_active="1" is_required="0" ordering="6"><![CDATA[a:3:{i:0;a:1:{s:15:"phrase_var_name";s:24:"user.cf_option_sometimes";}i:1;a:1:{s:15:"phrase_var_name";s:17:"user.cf_option_no";}i:2;a:1:{s:15:"phrase_var_name";s:18:"user.cf_option_yes";}}]]></field>
		<field group_name="user.custom_group_details" field_name="drinker" module_id="user" type_id="user_panel" phrase_var_name="user.custom_drinker" type_name="VARCHAR(150)" var_type="select" is_active="1" is_required="0" ordering="7"><![CDATA[a:3:{i:0;a:1:{s:15:"phrase_var_name";s:18:"user.cf_option_yes";}i:1;a:1:{s:15:"phrase_var_name";s:17:"user.cf_option_no";}i:2;a:1:{s:15:"phrase_var_name";s:24:"user.cf_option_sometimes";}}]]></field>
	</custom_field>
	<custom_group>
		<group module_id="user" type_id="user_profile" phrase_var_name="user.custom_group_about_me" is_active="1" ordering="1" />
		<group module_id="user" type_id="user_profile" phrase_var_name="user.custom_group_interests" is_active="1" ordering="2" />
		<group module_id="user" type_id="user_profile" phrase_var_name="user.custom_group_details" is_active="1" ordering="3" />
	</custom_group>
	<phrases>
...
Note: Enable this feature only if creating a plug-in or modifying the package.</phrase>
		...
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="custom_who_i_d_like_to_meet" added="1238671563"><![CDATA[Who I&#039;d Like to Meet]]></phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="custom_group_interests" added="1238671589">Interests</phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="custom_interests" added="1238671614">Interests</phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="custom_music" added="1238671629">Music</phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="custom_movies" added="1238671647">Movies</phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="custom_group_details" added="1238671708">Details</phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="custom_smoker" added="1238671738">Smoker</phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="cf_option_yes" added="1238671738">Yes</phrase>
...
friend921</info>]]></phrase>
		...
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="cf_option_no" added="1238671738">No</phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="cf_option_sometimes" added="1238671738">Sometimes</phrase>
		<phrase module_id="user" version_id="2.0.0alpha3" var_name="custom_drinker" added="1238749684">Drinker</phrase>
...
<b>Notice:</b> Set to "0" (without quotes) for no limit.</info>]]></phrase>
		...
		<phrase module_id="user" version_id="2.0.0beta5" var_name="setting_randomize_featured_members" added="1246007440"><![CDATA[<title>Random featured members</title><info>Should featured members randomly show up?

When this feature is disabled a new section will be shown in the Browse members in the Admin Panel (browsing for featured members) to set the ordering.</info>]]></phrase>
...
Leave to 0 for unlimited</phrase>
		...
		<phrase module_id="user" version_id="2.0.0rc1" var_name="setting_display_user_online_status" added="1248697618"><![CDATA[<title>Display User Online Status</title><info>Select <b>True</b> to display a users online status, which will alter the users profile image to distinguish from other members that are offline.</info>]]></phrase>
