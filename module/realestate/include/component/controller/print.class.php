 ...
 */
class Realestate_Component_Controller_Print extends Phpfox_Component
{
	/**
...
*/			return $dataSimilar;
		...
		//echo '<pre>'.print_r($adiPropDet,true).'</pre>';
		//exit;
		return $adiPropDet;
		...
		//$this->template()->setHeader('galleria-1.2.5.min.js', 'module_realestate');
		
		$idReal = Phpfox::getLib('request')->getInt('id');
		//$this->template()-> assign('current_url', $url);
		$this->template()->setHeader('sample.js', 'module_realestate');
		$this->template()->setHeader('style.css', 'module_realestate');
	}
