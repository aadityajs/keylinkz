    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="review">
	 ...
	 {php}
		if ($_POST['subReview'] && $_POST['subReview'] == "Submit Message") {
			...
			echo $insertReviewSql = "insert into `keylinkz_user_review` (review_id, user_id, by_user, review, service, service_yr, address, timestamp, status) values
																   (null, '$agent_id', '$by_user', '$review', '$selService', $yrservice, '$address', '$time', '1')";
