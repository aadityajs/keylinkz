...
<div class="item_info">
	<ul class="extra_info_middot">
		...
		{if $aMail.owner_user_id == Phpfox::getUserId()}
			...
			You <span class="js_hover_info">This message was sent from you</span>
			{else}
			{$aMail|user:'viewer_'}<span class="js_hover_info">{phrase var='mail.this_message_was_sent_from_full_name' full_name=$aMail|user:'viewer_'}</span>
			{/if}	
