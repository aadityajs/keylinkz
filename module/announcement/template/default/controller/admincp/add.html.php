 ...
 * @package 		Phpfox
 * @version 		$Id: add.html.php 3830 2011-12-19 12:55:57Z Miguel_Espinoza $
 */
...
<form action="{url link="current"}" method="post" id="frm_announcement">
	...
	<div class="table">
		...
		<div class="table_right">		   
			...
			<b>{$aLanguage.title}</b>
			<div class="p_4">
			    <input type="text" name="val[subject][{$aLanguage.language_id}][text]" value="{if isset($aLanguage.subject)}{$aLanguage.subject}{/if}" size="40" />
	...
	<div class="table">
		...
		<div class="table_right">
			...
			<b>{$aLanguage.title}</b>
			<div class="p_4">
			    <input type="text" name="val[intro][{$aLanguage.language_id}][text]" value="{if isset($aLanguage.intro)}{$aLanguage.intro}{/if}" size="40" />
	...
	<div class="table">
		...
		{foreach from=$aAnnouncement.language item=aLanguage}
			<b>{$aLanguage.title}</b>
			<div class="p_4">
			    <textarea cols="57" rows="5" name="val[content][{$aLanguage.language_id}][text]">{if isset($aLanguage.content)}{$aLanguage.content}{/if}</textarea>
