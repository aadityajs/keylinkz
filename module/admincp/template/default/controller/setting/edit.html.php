 ...
 * @version 		$Id: edit.html.php 3296 2011-10-12 13:29:57Z Raymond_Benc $
 */
...
<div class="table3">
	...
	<div class="row_right" style="margin-bottom:20px;">
		...
		<div><input type="text" name="val[value][{$aSetting.var_name}]" value="{$aSetting.value_actual}" size="40" /></div>		
