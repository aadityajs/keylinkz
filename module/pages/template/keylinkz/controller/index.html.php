...
<div id="js_pages_{$aPage.page_id}" class="js_pages_parent {if is_int($phpfox.iteration.pages/2)}row1{else}row2{/if}{if $phpfox.iteration.pages == 1 && !PHPFOX_IS_AJAX} row_first{/if}">
		<div class="row_title">
			<div class="row_title_image">
				<a href="{$aPage.link}">{img server_id=$aPage.profile_server_id title=$aPage.title path='core.url_user' file=$aPage.profile_user_image suffix='_50_square' max_width='50' max_height='50'}</a>
