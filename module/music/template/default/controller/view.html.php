...
<div class="item_view">
    <div class="item_info">
		{$aSong.time_stamp|convert_time} {phrase var='music.by_lowercase'} {$aSong|user}{if $aSong.album_id} {phrase var='music.in'} <a href="{permalink module='music.album' id=$aSong.album_id title=$aSong.album_url}" title="{$aSong.album_url|clean}">{$aSong.album_url|clean|shorten:50:'...'|split:50}</a>{/if}
    </div>
