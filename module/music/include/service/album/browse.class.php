 ...
 * @version 		$Id: browse.class.php 3246 2011-10-07 12:12:45Z Raymond_Benc $
 */
class Music_Service_Album_Browse extends Phpfox_Service 
{
	...
	public function query()
	{
		...
		{
			$this->database()->select('lik.like_id AS is_liked, ')->leftJoin(Phpfox::getT('like'), 'lik', 'lik.type_id = \'music_album\' AND lik.item_id = m.album_id AND lik.user_id = ' . Phpfox::getUserId());
		}		
	}
