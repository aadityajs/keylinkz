...
class Music_Component_Ajax_Ajax extends Phpfox_Ajax
{
	...
	public function playInFeed()
	{
		...
		$this->call('var iWait = 250;if (typeof $Core.player == "undefined"){iWait = 2000;}setTimeout(function(){$Core.player.load({id: \'' . $sDivId . '\', auto: true, type: \'music\', play: \'' . $sSongPath . '\'});}, iWait);');		
	}
