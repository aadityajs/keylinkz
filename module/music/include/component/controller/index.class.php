 ...
 * @version 		$Id: index.class.php 3737 2011-12-09 07:50:12Z Raymond_Benc $
 */
class Music_Component_Controller_Index extends Phpfox_Component
{
	...
	{		
		...
		$this->template()->setTitle(($bIsProfile ? $aUser['full_name'] . '\'s Songs' : 'Music'))->setBreadcrumb(Phpfox::getPhrase('music.music'), ($bIsProfile ? $this->url()->makeUrl($aUser['user_name'], 'music') : $this->url()->makeUrl('music')));
