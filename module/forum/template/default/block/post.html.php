			...
			<div class="forum_user_info_holder_inner">
				...
				<div class="forum_user_info">
					<div class="forum_thread_photo">
						{img user=$aPost suffix='_100_square' max_width=100 max_height=100}
					</div>
					...
					<div class="js_feed_comment_border">
						<ul>
							...
							{if Phpfox::isModule('like') && isset($aPost.Feed.like_type_id)}
								...
								{else}
									3 {module name='like.link' like_type_id=$aPost.aFeed.like_type_id like_item_id=$aPost.aFeed.item_id like_is_liked=$aPost.aFeed.feed_is_liked}
								{/if}				
