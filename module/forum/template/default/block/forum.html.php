 ...
 * @version 		$Id: forum.html.php 3342 2011-10-21 12:59:32Z Raymond_Benc $
 */
...
?>
		<div class="table_row">
			...
			<div class="forum_title">
					<a href="{permalink module='forum' id=$aForum.forum_id title=$aForum.name}"{if !empty($aForum.description)} title="{$aForum.description|parse}" {/if} class="forum_title_link">{$aForum.name|clean}</a>					
