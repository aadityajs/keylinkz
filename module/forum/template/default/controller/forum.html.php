...
<div class="forum_header_menu">
	<ul class="sub_menu_bar">	
		...
		<li class="sub_menu_bar_li">
			<a href="{if $aCallback === null}{url link='forum.rss' forum=$aForumData.forum_id}{else}{url link='forum.rss' group=$aCallback.item_id}{/if}" title="{phrase var='forum.subscribe_to_this_forum'}" class="no_ajax_link">
