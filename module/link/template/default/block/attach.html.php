...
<div class="js_preview_link_attachment_custom_add_parent">
	...
	<div class="js_preview_link_attachment_custom_holder" style="display:none;">
		<form method="post" action="#" onsubmit="return $Core.attachmentLinkAdd(this);">
			...
			<div class="attachment_link_button"><input type="submit" value="{phrase var='link.attach_link'}" class="button" /><span class="js_global_attach_link_ajax_add" class="v_middle" style="display:none; padding-left:4px;">{img theme='ajax/add.gif'}</span></div>
		</form>
	</div>
</div>