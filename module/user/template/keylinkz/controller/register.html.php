			...
			<div class="middle" id="js_registration_holder">
				...
				{token}
					...
					<div class="agreebox">
						...
						{if isset($bIsPosted) || !Phpfox::getParam('user.multi_step_registration_form')}
						<input type="submit" value="{phrase var='user.sign_up'}" class="r_btn" id="js_registration_submit" />
						{else}
							<input type="button" value="{phrase var='user.sign_up'}" class="r_btn" id="js_registration_submit" onclick="$Core.registration.submitForm();" />
						{/if}
						</div>
                        ...
                        <!--
						{if Phpfox::getParam('user.terms_and_cond')}
						<div id="js_register_accept" class="terms">
						<input type="checkbox" name="val[agree]" id="agree" value="1" class="checkbox v_middle" {value type='checkbox' id='agree' default='1'}/> {required}{phrase var='user.terms_and_cond'}
                    	</div>
						{/if}
						-->
                  	</div>
