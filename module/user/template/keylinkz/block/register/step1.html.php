	<div id="js_register_step1">
		...
		<div class="table">
			<div class="table_left">
				<label class="white_label" for="full_name">{required}{phrase var='user.full_name'}:</label>
			</div>
		...
		<div class="table">
			<div class="table_left">
				<label class="white_label" for="user_name">{required}{phrase var='user.choose_a_username'}:</label>
			</div>
			<div class="table_right">
		...
		<div class="table">
			<div class="table_left">
				<label class="white_label" for="email">{required}{phrase var='user.email'}:</label>
			</div>
			<div class="table_right">
		...
		<div class="table">
			<div class="table_left">
				<label class="white_label" for="password">{required}{phrase var='user.password'}:</label>
			</div>
			<div class="table_right">
				{if isset($bIsPosted)}
