	...
	{if Phpfox::getParam('core.registration_enable_gender')}
		<div class="table">
			<div class="table_left">
				<label class="white_label" for="gender">{required}{phrase var='user.i_am'}:</label>
			</div>
			<div class="table_right" style="margin-left:98px;">
				{select_gender}
			</div>
	...
	{if Phpfox::getParam('core.registration_enable_location')}
		<div class="table">
			<div class="table_left">
				<label class="white_label" for="country_iso">{required}{phrase var='user.location'}:</label>
			</div>
