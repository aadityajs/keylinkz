 ...
 * @version 		$Id: privacy.class.php 3588 2011-11-28 08:28:21Z Raymond_Benc $
 */
	...
	public function verify($sCategory, $iItemId, $iUserId, $bRedirect = true)
	{
		...
		if ($iCnt === 0)
		{
			$iCnt = $this->database()->select('COUNT(*)')
				->from($this->_sTable)
				->where("item_id = " . (int) $iItemId . " AND category_id = '" . $this->database()->escape($sCategory) . "' AND user_id = " . Phpfox::getUserId() . "")
