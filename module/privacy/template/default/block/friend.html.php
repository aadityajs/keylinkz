 ...
 * @author  		Raymond_Benc
 * @package 		Phpfox
 * @version 		$Id: friend.html.php 3642 2011-12-02 10:01:15Z Miguel_Espinoza $
 */
...
{/if}
	...
	<div id="js_custom_list_actual_holder">
		<form method="post" action="#" onsubmit="return $Core.updateCustomList(this);">
			...
			<div class="p_top_4">
				<input type="submit" class="button" value="Save" /> <a href="#" onclick="$('#js_create_custom_friend_list_holder').show(); $('#js_custom_list_actual_holder').hide(); return false;">{phrase var='privacy.or_create_a_new_list'}</a>
			</div>
		</form>
	</div>
