                ...
                <table width="350" border="2" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="padding: 11px 0;">
                        	<!--
                        	<div style="width:340px;height:320px;border:1px solid red;">
                            Content goes here
                            </div>
                        	-->
                            ...
                            <div class="ad-image-wrapper" id="galleryLightbox">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" style="padding: 8px 0;">
                            <tr>
