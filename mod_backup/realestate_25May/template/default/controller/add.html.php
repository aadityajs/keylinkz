...
<form method="post" action="{url link='realestate.add'}" enctype="multipart/form-data">
<input type="hidden" name="val[position]" id="position" />
<input type="hidden" name="val[images]" id="images" />
<input type="hidden" name="val[lat]" id="lat" />
<input type="hidden" name="val[lng]" id="lng" />
...
-->            
            ...
            <div class="table">
                ...
                <div class="table_right table_right_custom">
                     {editor id='realestate_desc' name='realestate_desc' cols='4'}  
                </div>
                <div class="clear"></div>
            </div>
            <!-- REAL ESTATE IMAGE UPLOAD -->
            ...
            <div class="table">
                ...
                <div class="table_right table_right_custom">
                {editor id='exterior_material' name='val[exterior_material]' cols='2'}
            ...
            <div class="table">
                ...
                <div class="table_right table_right_custom">
                {editor id='legal_desc' name='val[legal_desc]' cols='2'}
                    <!-- <textarea rows="2" cols="50" name="val[legal_desc]">{$data.legal_desc}</textarea> -->
                </div>
            </div>
            ...
            <div class="table">
                ...
                <div class="table_right table_right_custom">
                    <input type="text" class="textbox_style_small" name="val[per_floor_sqft]" value="{$data.per_floor_sqft}" id="total" size="40" maxlength="100" /> sq.ft
                </div>
            </div>
            <div class="clear"></div>
