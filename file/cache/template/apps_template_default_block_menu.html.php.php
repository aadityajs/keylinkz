...
<?php if (is_array ( $this->_aVars['aInstalledApps'] ) && count ( $this->_aVars['aInstalledApps'] )): ?>
	<div class="global_apps_title">
<?php echo Phpfox::getPhrase('apps.apps'); ?>
	</div>
...
)); ?>"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => 0,'path' => 'app.url_image','file' => $this->_aVars['aInstalledApp']['image_path'],'suffix' => '_square','max_width' => 16,'max_height' => 16,'title' => $this->_aVars['aInstalledApp']['app_title'],'class' => 'v_middle')); ?> <?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aInstalledApp']['app_title']); ?></a></li>
<?php endforeach; endif; ?>
		</ul>
	</div>
<?php endif; ?>

<?php if (is_array ( $this->_aVars['aInstalledPages'] ) && count ( $this->_aVars['aInstalledPages'] )): ?>
	<div class="global_apps_title">
<?php echo Phpfox::getPhrase('pages.pages'); ?>
	</div>
	<div class="sub_section_menu global_apps_title_padding">
		<ul>
<?php if (count((array)$this->_aVars['aInstalledPages'])):  foreach ((array) $this->_aVars['aInstalledPages'] as $this->_aVars['aInstalledPage']): ?>
			<li><a href="<?php echo $this->_aVars['aInstalledPage']['link']; ?>" title="<?php echo $this->_aVars['aInstalledPage']['title']; ?>"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => $this->_aVars['aInstalledPage']['user_server_id'],'title' => $this->_aVars['aInstalledPage']['title'],'path' => 'core.url_user','file' => $this->_aVars['aInstalledPage']['user_image'],'suffix' => '_50_square','max_width' => '16','max_height' => '16','class' => 'v_middle')); ?> <?php echo Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aInstalledPage']['title']), 22, '...'); ?></a></li>
<?php endforeach; endif; ?>
		</ul>
	</div>
<?php if (count ( $this->_aVars['aInstalledPages'] ) > $this->_aVars['iPageLimit']): ?>
	<div class="bottom">
		<ul>
			<li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('pages', array('view' => 'my')); ?>"><?php echo Phpfox::getPhrase('pages.view_more'); ?></a></li>
		</ul>
	</div>
<?php endif; ?>
<?php endif; ?>
