...
<?php $aContent = 'if (isset($this->_aVars[\'aFeed\']) && isset($this->_aVars[\'aFeed\'][\'comment_type_id\']) && $this->_aVars[\'aFeed\'][\'comment_type_id\'] == \'photo\' && isset($this->_aVars[\'aFeed\'][\'feed_display\']) && $this->_aVars[\'aFeed\'][\'feed_display\'] == \'view\')
{	
	...
	if (Phpfox::getUserParam(\'photo.can_view_all_photo_sizes\'))
	{
		echo \'<li><span>&middot;</span></li>\';
