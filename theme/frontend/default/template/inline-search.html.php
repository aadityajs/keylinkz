 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: inline-search.html.php 2197 2010-11-22 15:26:08Z Raymond_Benc $
 */
...
<div class="item{if $phpfox.iteration.inline == 1} first{/if}">
		...
		<div class="go_left t_right" style="width:21px; position:relative;">
			<a href="#?tag={$aRow.tag_text}" class="js_inline_search_link">{img no_link=true user=$aRow suffix='_20' max_width=20 max_height=20}</a>
		</div>
