...
<div class="p_4">
	The domain, sub-domain or sub-folder you are attempting to install phpFox to is not licensed to run our product. Please visit our clients area for more information on how to
	setup your license. 
	<p>
		For more information regarding our license policy and on where you can run our product for development purposes please check here.
	</p>
</div>
{else}
{if isset($sError)}
...
{$sCreateJs}
	...
	<div class="message">
		...
		<div class="p_4">
			To install your branding removal you will need to enter your phpFox login details. This is the same login details used to log into our clients area at http://www.phpfox.com/.
